                        ...
                        <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="accessories-details.php?accessories_id='.$row['accessories_id'].'">
                                                <img class="pri-img" src="admin_area/accessories_images/'.$row['accessories_image_1'].'" alt="product" style="height:180px;">
                                                <img class="sec-img" src="admin_area/accessories_images/'.$row['accessories_image_2'].'" alt="product" style="height:180px;">
                                            </a>
                                        ...
                                        <div class="product-caption text-center">
                                            ...
                                            <h6 class="product-name">
                                                <a href="accessories-details.php?accessories_id='.$row['accessories_id'].'">'.$row['accessories_name'].'</a>
                                            </h6>
                                            <div class="price-box">
                                                <span class="price-regular">Rs.'.$row['accessories_prices'].'</span>
