                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php
                                ...
                                $select_wishlist="select * from wishlist where customer_email='$customer_email' and status='yes'";
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="pro-thumbnail"><a
                                                href="bikes-<?php echo base64_encode($product_id); ?>"><img
                                                    class="img-fluid"
                                                    src="admin_area/product_images/<?php echo $product_img1 ?>"
                                                    alt="Product" /></a></td>
                                        <td class="pro-title">
                                            <a
                                                href="bikes-<?php echo base64_encode($product_id) ?>"><?php  echo  $product_name ?></a>
                                        </td>
                                        ...
                                        <td class="pro-remove"><a
                                                href="delete_wishlist-<?php echo base64_encode($wishilist_id); ?>"
                                    ...
                                    <tr>
                                        <td class="pro-thumbnail"><a
                                                href="accessories-<?php echo base64_encode($product_id); ?>"><img
                                                    class="img-fluid"
                                                    src="admin_area/accessories_images/<?php echo $accessories_image_1 ?>"
                                                    alt="accessories" /></a></td>
                                        <td class="pro-title">
                                            <a
                                                href="accessories-<?php echo base64_encode($product_id); ?>"><?php  echo $accessories_name; ?></a>
                                        </td>
                                        ...
                                        <td class="pro-remove"><a
                                                href="delete-wishlist?wishlist_id=<?php echo base64_encode($wishilist_id); ?>"
                                                class="btn-delete"><i class="fa fa-trash-o"></i></a></td>
                                    </tr>
                                    <?php 
