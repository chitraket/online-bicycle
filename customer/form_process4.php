...
$customer_email='';
$customer_address='';
$update_payment="update customer_orders set txnid='$txn_amount',payment_status='failed',order_status='f' where order_id='$order_id'";
$run_payment=mysqli_query($con,$update_payment);

$insert_payment="delete from payments where invoice_no='$invoice_no'";
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <table align="center" border="0" cellpadding="0" cellspacing="0" >
                                                        <tr>
                                                            <td>
                                                                <img src="cid:1002" alt="" style=";margin-bottom: 30px;hight:200px;width:300px;">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
