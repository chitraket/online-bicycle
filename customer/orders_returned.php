...
<?php
    ...
    while ($row_delete = mysqli_fetch_array($run_delete)) {
        ...
        $update_delete="update customer_orders set order_status='r',payment_status='returned' where order_id='$o_id'";
...
$gst=0;
                        ...
                        try {
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <table align="center" border="0" cellpadding="0" cellspacing="0" >
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h2 class="title">Returned Order</h2>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <p>As requested by we have returned your order#'.$o_id.'</p>
                            ...
                            $mail->Subject = "Returned of your Order No:$o_id at SKOTE";
                            $mail->Body    = "$html";  
                            $mail->AddEmbeddedImage("assets/img/email-temp/logo.png",1001,'logo.png');
                            $mail->AddEmbeddedImage("assets/img/email-temp/return.png",1002, 'delivery.png');
                            $mail->AddEmbeddedImage("assets/img/email-temp/return_1.png",1003,'success.png');
