        ...
        <div class="account-details-form">
            <form action="my-account" method="post" id="registration_form" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="single-input-item">
                            ...
                            <input type="text" name="c_name" id="f_name" placeholder="Enter your First name"
                    ...
                    <div class="col-lg-6">
                        <div class="single-input-item">
                            ...
                            <input type="text" placeholder="Enter your Last name" name="c_lname" id="l_name"
                                value="<?php echo $customer_lname; ?>" autocomplete="off" />
                ...
                <div class="single-input-item">
                    ...
                    <textarea placeholder="Enter your Address" name="c_address" id="address" cols="30"
                        rows="3"><?php echo $customer_address; ?></textarea>
                ...
                <div class="single-input-item">
                    ...
                    <img class="img-responsive my-4 " src="customer_images/<?php echo $customer_image; ?>"
                        style="width:100px;height:100px;" alt="Customer Image">
                </div>
                <div class="single-input-item">
