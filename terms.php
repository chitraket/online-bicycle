                            ...
                            <div class="myaccount-page-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-4">
                                        ...
                                        ?> 
                                            <a href="#<?php echo $term_link; ?>" class="active" data-toggle="tab"><i class="fa fa-dashboard"></i>
                                        ...
                                        <?php 
                                            ...
                                            while ($row_terms=mysqli_fetch_array($run_terms)) {
                                                ...
                                                $term_desc = $row_terms['term_desc'];
                                                $term_link = $row_terms['term_link']; ?>
                                            <a href="#<?php echo $term_link; ?>" data-toggle="tab"><i class="fa fa-cart-arrow-down"></i>
                                                <?php echo $term_title;?></a>
                                           <?php
                                            }
                                            ?>
