                    ...
                    <div class="breadcrumb-wrap">
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Privet Policy</li>
                            </ul>
                        </nav>
                    </div>
                </div>
                                ...
                                <div class="col-lg-3 col-md-4">
                                    <div class="myaccount-tab-menu nav" role="tablist">
                                        <?php 
                                            ...
                                            $get_terms = "select * from policy where policy_status='yes' LIMIT 0,1";
                                            $run_terms = mysqli_query($con,$get_terms);

                                            while($row_terms=mysqli_fetch_array($run_terms)){

                                                $term_title = $row_terms['policy_title'];
                                                $term_desc = $row_terms['policy_desc'];
                                                $term_link = $row_terms['policy_link'];
                                        ...
                                        <?php 
                                            ...
                                            $count_terms = "select * from policy  where policy_status='yes'";
                                            $run_count_terms = mysqli_query($con,$count_terms);
                                            $count = mysqli_num_rows($run_count_terms);
                                            $get_terms = "select * from policy where policy_status='yes' LIMIT 1,$count";
                                            $run_terms = mysqli_query($con,$get_terms);
