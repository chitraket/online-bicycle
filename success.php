                    ...
                    <div class="breadcrumb-wrap">
                        <div class="success-text">
                            <div class="section-title text-center" style="margin-top: 25px;">
                                ...
                                <p style="margin-top: 10px;">Payment is successfully processsed and your order is on the
                                    way</p>

                                <p style="margin-top: 10px;">Payment Method : <img
                                        src="assets/img/icon/icons8-paytm-32.png" style="height:25px;" /> Online Payment
                                </p>
                                <p style="margin-top: 10px;">Transaction ID:<?php echo  $txnid; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="cart-table table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td class="pro-thumbnail"><a href="bikes-<?php echo base64_encode($pro_id); ?>"><img
                                                class="img-fluid"
                                ...
                                <tr>
                                    <td class="pro-thumbnail"><a
                                            href="accessories-<?php echo base64_encode($pro_id); ?>"><img
                                                ...
                                                alt="Product" /></a></td>
                                    <td class="pro-title"><a
                                            href="accessories-<?php echo base64_encode($pro_id); ?>"><?php  echo $accessoires_name ?></a>
                                    </td>
                                    <td class="pro-price"><span><?php echo  $product_size ?></span></td>
