                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">View Terms</h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="employee_data" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <?php
                                              ...
                                              $select_cat="SELECT * FROM terms ORDER BY term_id DESC";
                                              $run_cart=mysqli_query($con, $select_cat);
                                            while ($row_cart=mysqli_fetch_array($run_cart)) {
                                               
                                                echo'<tr>
                                                <td>'.$row_cart["term_title"].'</td>
                                                <td>'.$row_cart["term_link"].'</td>
                                                <td>'.$row_cart["term_desc"].'</td>
                                                <td><a href="delete-term.php?term_id='.$row_cart["term_id"].'"><i class="bx bx-trash font-size-20 align-middle mr-1"></i></a><a href="update-term.php?term_id='.$row_cart["term_id"].'" class="pl-2"><i class="bx bx-edit font-size-20 align-middle mr-1"></i></a> </td>
                                                </tr>';
                                                 }?>
                                            </tbody>
                                        </table>
