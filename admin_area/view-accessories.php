                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="employee_data" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            while ($row_cart=mysqli_fetch_array($run_cart)) {
                                                ...
                                                echo'<tr>
                                                <td>
                                                <img src="accessories_images/'.$row_cart["accessories_image_1"].'" width="60" height="60"></td>
                                                <td>'.$row_cart["accessories_name"].'</td>
                                                <td>'.$row_cart["accessories_prices"].'</td>
                                                <td>'.$row_cart["accessories_qty"].'</td>
                                                <td>'.$row_cart["available_qty"].'</td>
                                                <td><input type="button" name="view" value="View Details" id="'.$row_cart["accessories_id"].'" class="btn btn-primary btn-sm btn-rounded waves-effect waves-light view_data"  /></td>
                                                <td><a href="delete-accessories.php?accessories_id='.$row_cart["accessories_id"].'"><i class="bx bx-trash font-size-20 align-middle mr-1"></i></a><a href="update-accessories.php?accessories_id='.$row_cart["accessories_id"].'" class="pl-2"><i class="bx bx-edit font-size-20 align-middle mr-1"></i></a> </td>
                                                </tr>';
                                                 }?>
                                            </tbody>
                                        </table>
