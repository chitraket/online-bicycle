                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="employee_data" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            while ($row_cart=mysqli_fetch_array($run_cart)) {
                                                ...
                                                <td><a href="delete-accessories-manufacturer.php?accessories_id='.$row_cart["accessories_category_id"].'"><i class="bx bx-trash font-size-20 align-middle mr-1"></i></a><a href="update-accessories-manufacturer.php?accessories_id='.$row_cart["accessories_category_id"].'" class="pl-2"><i class="bx bx-edit font-size-20 align-middle mr-1"></i></a> </td>
                                                </tr>';
                                                 }?>
                                            </tbody>
                                        </table>
