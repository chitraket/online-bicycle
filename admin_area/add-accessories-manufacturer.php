    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Add Accessoires Manufacturer</h4>   
                </div>
            </div>
        </div>     
        <!-- end page title -->
        ...
        <?php  
            ...
            if(isset($_POST['submit'])){
                ...
                $insert_cat = "insert into accessories_brand(accessories_brand,accessories_brand_top,accessories_brand_status) values('$manufacturer_title','$cat_top','yes')";
            ...
            <script>
                    swal({
                        title: "Your New Accessories Manufacturer Has Been Inserted.",
                        text: "",
                        icon: "success",
                        buttons: [,"OK"],
                        successMode: true,
...
$(document).ready(function(){  
 ...
 { 
     if(counter<=30)
     {
                ...
                .then((willDelete) => {
                        if (willDelete) {
                            window.open('add-accessories-manufacturer.php','_self');
                        } 
                        else
                        {
