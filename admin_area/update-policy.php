                    ...
                    <div class="card-body">
                       <form method="POST" enctype="multipart/form-data"> 
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" placeholder="Policy Title " name="term_title" value="<?php echo $term_title; ?>" id="example-text-input">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="example-text-input" class="col-md-3 col-form-label">Policy Link</label>
                                <div class="col-md-9">
                                    <input class="form-control" type="text" placeholder="Policy Link" name="term_link" value="<?php echo $term_link; ?>" id="example-text-input">
                                </div>
                            </div>
