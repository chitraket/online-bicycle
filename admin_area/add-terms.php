                    ...
                    <div class="card-body">
                       <form class="custom-validation" method="POST" enctype="multipart/form-data"> 
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" placeholder="Terms Title" name="terms_title"  id="example-text-input" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" placeholder="Terms Link" name="terms_link"  id="example-text-input" required>
