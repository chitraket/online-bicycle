                    ...
                    <div class="card-body">
                       <form class="custom-validation" method="POST" enctype="multipart/form-data"> 
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" placeholder="Term Title " name="term_title" value="<?php echo $term_title; ?>" id="example-text-input" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" placeholder="Term Link" name="term_link" value="<?php echo $term_link; ?>" id="example-text-input" required>
...
$(document).ready(function(){  
 ...
 { 
     if(counter<=30)
     {
                ...
                .then((willDelete) => {
                        if (willDelete) {
                            window.open('update-term.php','_self');
                        } 
                        else
                        {
