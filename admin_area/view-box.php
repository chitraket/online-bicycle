                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="employee_data" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            while ($row_cart=mysqli_fetch_array($run_cart)) {
                                                ...
                                                echo'<tr>
                                                <td>'.$row_cart["box_icon"].'</td>
                                                <td>'.$row_cart["box_title"].'</td>
                                                <td>'.$row_cart["box_desc"].'</td>
                                                <td><a href="delete-box.php?box_id='.$row_cart["box_id"].'"><i class="bx bx-trash font-size-20 align-middle mr-1"></i></a><a href="update-box.php?box_id='.$row_cart["box_id"].'" class="pl-2"><i class="bx bx-edit font-size-20 align-middle mr-1"></i></a> </td>
                                                </tr>';
                                                 }?>
                                            </tbody>
                                        </table>
