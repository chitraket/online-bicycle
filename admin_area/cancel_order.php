...
$totals=0;
                    ...
                    try {
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <table align="center" border="0" cellpadding="0" cellspacing="0" >
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <p>As requested by we have cancelled your order#'.$order_id.'</p>
                        ...
                        $mail->Subject = "Cancellation of your Order No:$order_id at SKOTE";
                        $mail->Body    = "$html";  
                        $mail->AddEmbeddedImage("assets/images/email-temp/logo.png",1001,'logo.png');
                        $mail->AddEmbeddedImage("assets/images/email-temp/cancel.png",1002, 'delivery.png');
                        $mail->AddEmbeddedImage("assets/images/email-temp/cancel_1.png",1003,'success.png');
                        
                        $mail->AddEmbeddedImage("assets/images/email-temp/facebook.png",1004, 'facebook.png');
                        $mail->AddEmbeddedImage("assets/images/email-temp/youtube.png", 1005, 'youtube.png');
                        $mail->AddEmbeddedImage("assets/images/email-temp/twitter.png",1006,  'twitter.png');
                        $mail->AddEmbeddedImage("assets/images/email-temp/pinterest.png",1007,  'pinterest.png');          
