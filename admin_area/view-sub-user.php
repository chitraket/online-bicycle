                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">View Sub User</h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="employee_data" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <?php
                                              ...
                                              $select_cat="SELECT * FROM admins where admin_roles='sub' ORDER BY admin_id DESC";
                                            ...
                                            while ($row_cart=mysqli_fetch_array($run_cart)) {
                                               ?>
                                                ...
                                                <td>
                                               <?php 
                                                if($row_cart['admin_status']=="yes")
                                                {
                                                ?>
                                                    <input type="checkbox" id="<?php echo $row_cart['admin_id']; ?>" class="switch1" name="no" switch="none" checked/>
                                                    <label for="<?php echo $row_cart['admin_id']; ?>" data-on-label="On"
                                                    data-off-label="Off"></label>
                                                <?php
                                                }
                                                else{
                                                    ?>
                                                    <input type="checkbox" id="<?php echo $row_cart['admin_id']; ?>" class="switch1" name="yes" switch="none" />
                                                    <label for="<?php echo $row_cart['admin_id']; ?>" data-on-label="On"
                                                    data-off-label="Off"></label>
                                                    <?php 
                                                } 
                                                ...
                                                <td><a href="delete-sub-user.php?admin_id=<?php echo $row_cart["admin_id"] ?>" class="btn-delete"><i class="bx bx-trash font-size-20 align-middle mr-1"></i></a><a href="update-sub-user.php?admin_id=<?php echo $row_cart["admin_id"];?>" class="pl-2"><i class="bx bx-edit font-size-20 align-middle mr-1"></i></a> </td>
                                            </tr>
                                                <?php 
                                                 }?>
                                            </tbody>
   ...
   counter--;
         ...
         <script>
                    $('.switch1').on('click',function(){
                        var admin_ids=$(this).attr("id");
                        var admin_idss=$(this).attr("name");
                        $.ajax({
                            url:"admin-sub-status.php",
                            method:"POST",
