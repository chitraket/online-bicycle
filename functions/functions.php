...
function getPCats(){
    global $db;
    $sql="SELECT * FROM product_categories ORDER BY p_cat_id";
    $result=$db->query($sql);
...
function  getAbrand(){
    global $db;
    $sql="SELECT DISTINCT * FROM accessories_brand ORDER BY accessories_brand_id";
    $result=$db->query($sql);
    while ($row=$result->fetch_assoc()) {
        echo '
    <li>
...
function getAcategory(){
    global $db;
    $sql="SELECT *  FROM accessories_category ORDER BY accessories_category_id";
    $result=$db->query($sql);
    while ($row=$result->fetch_assoc()) {
        echo '
    <li>
...
function getMCats(){
    global $db;
    $sql="SELECT * FROM manufacturers ORDER BY manufacturer_id";
    $result=$db->query($sql);
    while ($row=$result->fetch_assoc()) {
        echo '
        <li>
